        ...
        with mp_face_mesh.FaceMesh(
            ...
            def T_ZONE():
                ...
                if tskintone < t_min:
                    ...
                    tscore = 1 - ((tskintone - t_min) / (t_max - t_min))
            ...
            def E_ZONE():
                ...
                if eskintone < e_min:
                    ...
                    escore = 1 - ((eskintone - e_min) / (e_max - e_min))
            ...
            def C_ZONE():
                ...
                if cskintone < c_min:
                    ...
                    cscore = 1 - ((cskintone - c_min) / (c_max - c_min))
            ...
            def U_ZONE():
                ...
                if uskintone < u_min:
                    ...
                    uscore = 1 - ((uskintone - u_min) / (u_max - u_min))
