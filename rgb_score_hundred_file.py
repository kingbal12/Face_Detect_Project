        ...
        with mp_face_mesh.FaceMesh(
            ...
            def T_ZONE():
                ...
                if tskintone < t_min:
                    ...
                    tscore = 50 + (tskintone - 101) * (50 / (241 - 101))
            ...
            def E_ZONE():
                ...
                if eskintone < e_min:
                    ...
                    escore = 50 + (eskintone - 101) * (50 / (241 - 101))
            ...
            def C_ZONE():
                ...
                if cskintone < c_min:
                    ...
                    cscore = 50 + (cskintone - 101) * (50 / (241 - 101))
            ...
            def U_ZONE():
                ...
                if uskintone < u_min:
                    ...
                    uscore = 50 + (uskintone - 101) * (50 / (241 - 101))
            ...
            dst = cv2.resize(image, dsize=(640, 900), interpolation=cv2.INTER_AREA)
