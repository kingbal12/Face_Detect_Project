...
path = "C:/Users/USER/JM/wrinkle_RGB_flask/img/rgb/"
imgname = "3after"
photo_format = ".jpg"
...
def find_rgb(path):
    ...
    with mp_face_mesh.FaceMesh(
        ...
        if results.multi_face_landmarks:
            for face_landmarks in results.multi_face_landmarks:
                ...
                def BETWEEN_THE_EYEBROWS():
                    ...
                    return RGB_AVERAGE(top, bottom, right, left, "BETWEEN_THE_EYEBROWS")
                ...
                def UNDER_THE_EYE_RIGHT():
                    ...
                    return RGB_AVERAGE(top, bottom, right, left, "UNDER_THE_EYE_RIGHT")
                ...
                def UNDER_THE_EYE_LEFT():
                    ...
                    return RGB_AVERAGE(top, bottom, right, left, "UNDER_THE_EYE_LEFT")
                ...
                def LEFT_CORNER_OF_MOUTH():
                    ...
                    return RGB_AVERAGE(top, bottom, right, left, "LEFT_CORNER_OF_MOUTH")
        ...
        def T_ZONE():
            ...
            rgb_json["T_ZONE_RGB_TONE"] = (
                T_ZONE_RGB_AVERAGE[0] + T_ZONE_RGB_AVERAGE[1] + T_ZONE_RGB_AVERAGE[2]
            ) / 3
        ...
        def E_ZONE():
            ...
            rgb_json["E_ZONE_RGB_TONE"] = (
                E_ZONE_RGB_AVERAGE[0] + E_ZONE_RGB_AVERAGE[1] + E_ZONE_RGB_AVERAGE[2]
            ) / 3
        ...
        def C_ZONE():
            ...
            rgb_json["C_ZONE_RGB_TONE"] = (
                C_ZONE_RGB_AVERAGE[0] + C_ZONE_RGB_AVERAGE[1] + C_ZONE_RGB_AVERAGE[2]
            ) / 3
        ...
        def U_ZONE():
            ...
            rgb_json["U_ZONE_RGB_TONE"] = (
                U_ZONE_RGB_AVERAGE[0] + U_ZONE_RGB_AVERAGE[1] + U_ZONE_RGB_AVERAGE[2]
            ) / 3
            rgb_json["U_ZONE_RGB_AVERAGE"] = U_ZONE_RGB_AVERAGE
            return U_ZONE_RGB_AVERAGE

        def NOSE_TIP_ZONE():
            rgb_json["NOSE_TIP"] = NOSE_TIP()
